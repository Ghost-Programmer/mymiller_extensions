...
public class AdvancedCalendar {
     ...
     *
     * @param anotherCalendar the AdvancedCaldendar to be compared.
     ...
     */
    public int compareTo(AdvancedCalendar anotherCalendar) {
        return this.calendar.compareTo(anotherCalendar.toCalendar());
    }
     ...
     *
     * @param field the calendar field.
     * @return true if the given calendar field has a avalue set; false otherwise.
     ...
     */
    public boolean isAfter(AdvancedCalendar calendar) {
        return this.compareTo(calendar) > 0;
    }
     ...
     */
    public boolean isBefore(AdvancedCalendar calendar) {
        return this.compareTo(calendar) < 0;
    }
